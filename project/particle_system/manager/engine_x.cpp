...
void					manager::engine_build()
{
	...
	engine.generate_callback(engine::event::type::mouse_release, &manager::function_mouse_key, this);
	engine.generate_callback(engine::event::type::mouse_scroll, &manager::function_mouse_scroll, this);
